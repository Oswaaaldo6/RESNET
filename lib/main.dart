...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Oswaldo Corona RESNET'),
    );
  }
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final url = Uri.parse("https://resnet-service-oswaaaldo6.cloud.okteto.net/v1/models/resnet:predict");
  ...
  Future getImage(ImageSource source) async {
    try{
      ...
      print("Falló al conseguir recursos de las imagenes: $e");
    }
  }
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        Alert(
          ...
          desc: "Clase: $class_result_prediction",
          buttons: [
            DialogButton(
              child: Text(
                "ACEPTAR",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Oswaldo Corona Resnet"),
      ),
      body: Center(
        child: Column(
          children: [
